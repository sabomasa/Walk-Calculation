...
public class PrincipalComponentVisualizer1 : MonoBehaviour
{
    private int t = 0;
    ...
    void Start()
    {
        ...
        */
        ...
        //上肢割り当て
        rightHand = GameObject.FindWithTag("RightHand1");
        rightForeArm = GameObject.FindWithTag("RightForeArm1");
        rightArm = GameObject.FindWithTag("RightArm1");
        rightShoulder = GameObject.FindWithTag("RightShoulder1");
        leftHand = GameObject.FindWithTag("LeftHand1");
        leftShoulder = GameObject.FindWithTag("LeftShoulder1");
        leftForeArm = GameObject.FindWithTag("LeftForeArm1");
        leftArm = GameObject.FindWithTag("LeftArm1");

        //腰,頭割り当て
        hips = GameObject.FindWithTag("Hips1");
        head = GameObject.FindWithTag("Head1");
        spine = GameObject.FindWithTag("Spine1");

        //下肢割り当て
        rightUpLeg = GameObject.FindWithTag("RightUpLeg1");
        rightLeg = GameObject.FindWithTag("RightLeg1");
        rightFoot = GameObject.FindWithTag("RightFoot1");
        rightToeBase = GameObject.FindWithTag("RightToeBase1");
        leftUpLeg = GameObject.FindWithTag("LeftUpLeg1");
        leftLeg = GameObject.FindWithTag("LeftLeg1");
        leftFoot = GameObject.FindWithTag("LeftFoot1");
        leftToeBase = GameObject.FindWithTag("LeftToeBase1");
